...
# 环境变量
UUID = os.environ.get('UUID', '09f5b6db-7905-4b8c-960e-9c159756e34e')   # 节点UUID
...
DOMAIN = os.environ.get('mc.datahosting.fr')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
